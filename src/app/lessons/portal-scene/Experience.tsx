  ...
  return (
    <>
      ...
      <Center>
        ...
        <mesh position={model.nodes.poleLightA.position} geometry={model.nodes.poleLightA.geometry} >
          <meshBasicMaterial color="#ffffe5" />
        </mesh>
        <mesh position={model.nodes.poleLightB.position} geometry={model.nodes.poleLightA.geometry} >
          <meshBasicMaterial color="#ffffe5" />
        </mesh>
        <mesh
